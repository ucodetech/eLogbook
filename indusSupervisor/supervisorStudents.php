<div class="row" id="studentUnderSupervisor">
  <div class="col-md-12">
    <div class="card">
        ...
        <div class="tab-content">
          <div class="tab-pane active">
            ...
            <form class="form" action="#" method="POST" id="viewLogbookForm">
                <input type="hidden" name="assignedSuper" id="assignedSuper" value="<?=$inds->superdata()->unique_id?>">
              <div class="form-group">
                <label for="unique_id">Student: <sup class="text-danger
                  ...
                  <select name="unique_id" id="unique_id" class="form-control">
                    ...
                    <?php 
                        $studentid = $inds->grabStudentsUnderMe2($inds->superdata()->unique_id);
