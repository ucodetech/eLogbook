...
$fullname = $inds->superdata()->fullname;
$email = $inds->superdata()->comp_email;

$uniqueid = $inds->superdata()->unique_id;

// on register verify email address one time action
      ...
      if ($query->count()) {
          ...
          if ($cuDate != $date) {
            ...
            return false;
                ...
                $verified = "UPDATE inds_supervisors SET verified = 1 WHERE unique_id = '$uniqueid' ";
